...
@ProviderFor(SessionReminderEnabled)
const sessionReminderEnabledProvider = SessionReminderEnabledFamily._();

final class SessionReminderEnabledProvider
    extends $NotifierProvider<SessionReminderEnabled, bool> {
  const SessionReminderEnabledProvider._({
    required SessionReminderEnabledFamily super.from,
    required int super.argument,
  }) : super(
         retry: null,
         name: r'sessionReminderEnabledProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$sessionReminderEnabledHash();

  @override
  String toString() {
    return r'sessionReminderEnabledProvider'
        ''
        '($argument)';
  }
  ...
  @$internal
  @override
  SessionReminderEnabled create() => SessionReminderEnabled();
  ...
  @override
  bool operator ==(Object other) {
    return other is SessionReminderEnabledProvider &&
        other.argument == argument;
  }
...
String _$sessionReminderEnabledHash() =>
    r'3243bb776e568bf7282e414f3a765a8f5f878092';

final class SessionReminderEnabledFamily extends $Family
    with $ClassFamilyOverride<SessionReminderEnabled, bool, bool, bool, int> {
  const SessionReminderEnabledFamily._()
    : super(
        retry: null,
        name: r'sessionReminderEnabledProvider',
        dependencies: null,
  ...
  SessionReminderEnabledProvider call(int sessionId) =>
      SessionReminderEnabledProvider._(argument: sessionId, from: this);

  @override
  String toString() => r'sessionReminderEnabledProvider';
}

abstract class _$SessionReminderEnabled extends $Notifier<bool> {
...
@ProviderFor(SessionReminderLeadMinutes)
const sessionReminderLeadMinutesProvider = SessionReminderLeadMinutesFamily._();

final class SessionReminderLeadMinutesProvider
    extends $NotifierProvider<SessionReminderLeadMinutes, int?> {
  const SessionReminderLeadMinutesProvider._({
    required SessionReminderLeadMinutesFamily super.from,
    required int super.argument,
  }) : super(
         retry: null,
         name: r'sessionReminderLeadMinutesProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$sessionReminderLeadMinutesHash();

  @override
  String toString() {
    return r'sessionReminderLeadMinutesProvider'
        ''
        '($argument)';
  }
  ...
  @$internal
  @override
  SessionReminderLeadMinutes create() => SessionReminderLeadMinutes();
  ...
  @override
  bool operator ==(Object other) {
    return other is SessionReminderLeadMinutesProvider &&
        other.argument == argument;
  }
...
String _$sessionReminderLeadMinutesHash() =>
    r'1439086989c997d658ff6325cb6340f0f1b67b22';

final class SessionReminderLeadMinutesFamily extends $Family
    with
        $ClassFamilyOverride<
          ...
          int
        > {
  const SessionReminderLeadMinutesFamily._()
    : super(
        retry: null,
        name: r'sessionReminderLeadMinutesProvider',
        dependencies: null,
  ...
  SessionReminderLeadMinutesProvider call(int sessionId) =>
      SessionReminderLeadMinutesProvider._(argument: sessionId, from: this);

  @override
  String toString() => r'sessionReminderLeadMinutesProvider';
}

abstract class _$SessionReminderLeadMinutes extends $Notifier<int?> {
  late final _$args = ref.$arg as int;
  int get sessionId => _$args;

  int? build(int sessionId);
  @$mustCallSuper
  @override
  void runBuild() {
    final created = build(_$args);
...
@ProviderFor(SessionReminderSaving)
const sessionReminderSavingProvider = SessionReminderSavingFamily._();

final class SessionReminderSavingProvider
    extends $NotifierProvider<SessionReminderSaving, bool> {
  const SessionReminderSavingProvider._({
    required SessionReminderSavingFamily super.from,
    required int super.argument,
  }) : super(
         retry: null,
         name: r'sessionReminderSavingProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$sessionReminderSavingHash();

  @override
  String toString() {
    return r'sessionReminderSavingProvider'
        ''
        '($argument)';
  }
  ...
  @$internal
  @override
  SessionReminderSaving create() => SessionReminderSaving();
  ...
  @override
  bool operator ==(Object other) {
    return other is SessionReminderSavingProvider && other.argument == argument;
  }
...
String _$sessionReminderSavingHash() =>
    r'92afba42f3f49e4587f1506b2969fa8ddea16022';

final class SessionReminderSavingFamily extends $Family
    with $ClassFamilyOverride<SessionReminderSaving, bool, bool, bool, int> {
  const SessionReminderSavingFamily._()
    : super(
        retry: null,
        name: r'sessionReminderSavingProvider',
        dependencies: null,
  ...
  SessionReminderSavingProvider call(int sessionId) =>
      SessionReminderSavingProvider._(argument: sessionId, from: this);

  @override
  String toString() => r'sessionReminderSavingProvider';
}

abstract class _$SessionReminderSaving extends $Notifier<bool> {
  late final _$args = ref.$arg as int;
  int get sessionId => _$args;
