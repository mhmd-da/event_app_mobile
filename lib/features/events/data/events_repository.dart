...
class EventsRepository extends BaseApiRepository<EventModel> {
  EventsRepository(super._apiClient)
    : super(fromJson: (json) => EventModel.fromJson(json));

  Future<List<EventModel>> getEvents() async =>
      await fetchList(AppConfig.getEvents);

  Future<EventDetailsModel> getEventDetails(int eventId) async =>
      await fetchSingleGeneric<EventDetailsModel>(
        AppConfig.getEventDetails(eventId),
