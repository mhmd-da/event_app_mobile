...
class QuickActionsGrid extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final items = [
      ...
      ("Workshops", Icons.school, MentorsPage()),
      ("Panels", Icons.tab_rounded, MentorsPage()),
      ("Round-Tables", Icons.table_restaurant, MentorsPage()),
      ("Speakers", Icons.mic, SpeakersPage()),
      ("Mentors", Icons.people, MentorsPage()),
      ("My Schedule", Icons.schedule, MySchedulePage()),
      ("Venue Map", Icons.map, SpeakersPage()),
      ("FAQs", Icons.help_outline, SpeakersPage()),
    ];
